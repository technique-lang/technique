...
decimal places) is arbitrary within the available range. This isn't really for
numerical analysis. It is for carrying information.

/Implementation note/

Internally this is a floating point where the mantissa is 19 characters wide
(the width of a 64-bit int in base 10). Thus the biggest number representable
is 9223372036854775807 and the smallest is 0.0000000000000000001. We could
change this to Integer and be arbitrary precision but meh.
-}
